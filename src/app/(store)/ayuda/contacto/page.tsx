...
export const metadata: Metadata = {
  title: 'Contacto | UrbanStore',
  description: 'Contacta con UrbanStore Oviedo. Dirección, teléfono, email y horarios.',
}
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-12 pb-24">
      <div className="max-w-2xl">
        ...
        <h1 className="text-3xl font-bold tracking-tight uppercase mb-10">Contacto</h1>
